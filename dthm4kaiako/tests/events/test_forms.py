...
class EventApplicationFormTests(TestCase):
    ...
    def test_invalid_participant_type_integer_gives_error(self):
        ...
        self.assertEqual(event_application_form.errors['participant_type'], ['Select a valid choice. That choice is not one of the available choices.'])
    ...
    def test_invalid_emergency_contact_first_name__too_long(self):
        ...
        self.assertEqual(event_application_form.errors["emergency_contact_first_name"], ["Ensure this value has at most 50 characters (it has 51)."])
    ...
    def test_invalid_emergency_contact_last_name__too_long(self):
        ...
        self.assertEqual(event_application_form.errors["emergency_contact_last_name"], ["Ensure this value has at most 50 characters (it has 51)."])
        ...
        event_application_form = EventApplicationForm(data=
                {
                    ...
                    "emergency_contact_first_name": 'John',
                    "emergency_contact_last_name": "Jones",
                    "emergency_contact_relationship": "My sister's friend's brother's girl friend's dog's breeder's mother's sister's professional lawn mower who comes on Tuesdays, Thursdays and Sundays that has a floppy hat.",
                    "emergency_contact_phone_number": "123456789"
                    }
            )
        self.assertEqual(event_application_form.errors["emergency_contact_relationship"], ["Ensure this value has at most 150 characters (it has 170)."])
    ...
    def test_invalid_emergency_contact_phone_number__invalid_symbols(self):
        ...
        self.assertEqual(event_application_form.errors["emergency_contact_phone_number"], ['Phone number can include the area code, follow by any number of numbers, - and spaces. E.g. (+64) 123 45 678, 123-45-678, 12345678'])
    ...
    def test_invalid_emergency_contact_phone_number__plus_integers_and_spaces(self):
        ...
        self.assertEqual(event_application_form.errors["emergency_contact_phone_number"], {})
    ...
    def test_missing_emergency_contact_first_name(self):
        ...
        self.assertEqual(event_application_form.errors["emergency_contact_first_name"], ['This field is required.'])
    ...
    def test_missing_emergency_contact_relationship(self):
        ...
        self.assertEqual(event_application_form.errors["emergency_contact_relationship"], ['This field is required.'])
    ...
    def test_missing_emergency_contact_phone_number(self):
        ...
        self.assertEqual(event_application_form.errors["emergency_contact_phone_number"], ['This field is required.', 'Phone number can include the area code, follow by any number of numbers, - and spaces. E.g. (+64) 123 45 678, 123-45-678, 12345678'])
    ...
    def test_missing_emergency_contact_last_name(self):
        ...
        self.assertEqual(event_application_form.errors["emergency_contact_last_name"], ['This field is required.'])
