...
class DeleteRegistrationViaEventPageViewTest(BaseTestWithDB):
    ...
    def test_delete_registration_via_event_page_view_url_returns_200_when_event_exists(self):
        ...
        self.assertEqual(response['Location'], f'/events/event/{event.pk}/{event.slug}/')

    def test_delete_registration_via_event_page_and_logged_in_and_mine_then_successfully_deleted(self):
        event = Event.objects.create(
            name="Security in CS",
            description="description",
            registration_type=2,
    ...
    def test_delete_registration_via_event_page_and_not_logged_in_and_mine_then_redirected(self):
        event = Event.objects.create(
            name="Security in CS",
            description="description",
            registration_type=2,
        ...
        response = self.client.post(url, {"withdraw_reason": "1", "other_reason_for_withdrawing": ""})
        self.assertEqual(HTTPStatus.FOUND, response.status_code)
        self.assertEqual(response['Location'], f'/accounts/login/?next=/events/delete-via-event/{event_registration.pk}/')

    def test_delete_registration_via_event_page_and_logged_in_and_not_mine_then_redirected(self):
        event = Event.objects.create(
            name="Security in CS",
            description="description",
            registration_type=2,
        ...
        response = self.client.post(url, {"withdraw_reason": "1", "other_reason_for_withdrawing": ""})
        self.assertEqual(HTTPStatus.FOUND, response.status_code)
        self.assertEqual(response['Location'], f'/events/')
