...
class DeleteRegistrationViaRegistrationsPageURLTest(BaseTestWithDB):
    ...
    def test_valid_delete_registration_via_registration_page_view_url(self):
        ...
        expected_url = f"/events/delete-via-registrations/{event_registration.pk}/"
    ...
    def test_delete_registration_via_registration_page_view_resolve_provides_correct_view_name(self):
        ...
        event_registration.save()
        self.assertEqual(
            resolve(f"/events/delete-via-registrations/{event_registration.pk}/").view_name,
