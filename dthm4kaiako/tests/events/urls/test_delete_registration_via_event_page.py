...
class DeleteRegistrationViaEventPageURLTest(BaseTestWithDB):
    ...
    def test_valid_delete_registration_via_event_page_url(self):
        generate_addresses()
        generate_serieses()
        generate_locations()
        generate_events()
    ...
    def test_delete_registration_via_event_page_resolve_provides_correct_view_name(self):
        generate_addresses()
        generate_serieses()
        generate_locations()
        generate_events()
        ...
        self.assertEqual(resolve(f"/events/delete-via-event/{registration.pk}/").view_name, "events:delete_registration_via_event_page")

    # TODO: fix - giving 302 instead of 200
    def test_delete_registration_via_event_page_returns_200_when_registration_exists(self):
        generate_addresses()
        generate_serieses()
        generate_locations()
        generate_events()
