...
def generate_dietary_requirements():
    ...
    dietary_requirement_diary_free = DietaryRequirement.objects.create(name="Dairy free")
    ...
    dietary_requirement_paleo = DietaryRequirement.objects.create(name="Paleo")
    dietary_requirement_fodmap = DietaryRequirement.objects.create(name="FODMAP")
    dietary_requirement_nut_allergies = DietaryRequirement.objects.create(name="Nut allergies")
    dietary_requirement_seafood_allergies = DietaryRequirement.objects.create(name="Fish and shellfish allergies")
    ...
    dietary_requirement_coffee = DietaryRequirement.objects.create(name="As long as there's coffee, I'm happy!")
...
def generate_applicant_types():
    ...
    application_type_event_staff = ApplicantType.objects.create(name="Event staff")
    application_type_teacher = ApplicantType.objects.create(name="Teacher")
    application_type_student = ApplicantType.objects.create(name="Student")
