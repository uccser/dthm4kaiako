...
openssl aes-256-cbc -K "${encrypted_573fe49b15bd_key}" -iv "${encrypted_573fe49b15bd_iv}" -in ./infrastructure/prod-deploy/prod-deploy-secrets.tar.enc -out ./dthm4kaiako/prod-deploy-secrets.tar -d
